...
st.set_page_config(page_title="Connection & Resume Suggestion System", page_icon=":chart_with_upwards_trend:", layout="centered")

# Display the title and introduction
st.title("Welcome to the Connection & Resume Suggestion System")
